...
module.exports = (router) => {
  router.post(
    "/update-event-fees-strike-force",
    [authorization],
    async (req, res) => {
      ...
      try {
        ...
        return res
          .status(200)
          .json({
            message: "update-event-fees-strike-force updated successfully",
          });
      } catch (error) {
        console.log("UPDATE update-event-fees-strike-force error", error);
